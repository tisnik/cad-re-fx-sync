...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    ...
    <body>
        ...
        <table border="2" frame="border" rules="all" cellspacing="1" cellpadding="1" class="formular" style="width:600px" summary="" bordercolorlight="black">
            <tr>
                <td>
                    &nbsp;<a href="CreateNewFloorStage1"><img src="img/edit.gif" border="0" />Nová varianta podlaží</a>
                </td>
            </tr>
            <%--
            <tr>
                <td>
                    &nbsp;<a href="SaveChanges"><img src="img/filesave.png" border="0" />&nbsp;Uložit změny</a>
                </td>
            </tr>
            <tr>
                <td>
                    &nbsp;<a href="LoadDataModel"><img src="img/fileopen.png" border="0" />&nbsp;Načíst data z externího souboru</a>
                </td>
            </tr>
            --%>
        </table>
        <h2>Budovy a podlaží</h2>
